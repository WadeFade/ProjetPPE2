			...
			$retour.="<article class='d-flex m-3' style='width: 30%'>
						<div class='position-relative d-flex w-100 h-100 align-items-center justify-content-end'>
							...
							<div class='ImageGalerie position-absolute d-flex bg-secondary w-100 h-100 text-center justify-content-center align-items-center' style='opacity: 1%' onmouseover='this.style.opacity=\"80%\"'; onmouseleave='this.style.opacity=\"0\"''>
								...
								<button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#exampleModalLong".$id[$i]."\">
									Voir plus <i class=\"fas fa-caret-right\"></i>
								</button>
										<div class=\"modal fade\" id=\"exampleModalLong".$id[$i]."\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle".$id[$i]."\" aria-hidden=\"true\">
										  <div class=\"modal-dialog\" role=\"document\">
											<div class=\"modal-content\">
											  <div class=\"modal-header\">
												<h5 class=\"modal-title\" id=\"exampleModalLongTitle\">".$titre[$i]."</h5>
											  ...
											  <img class='img-fluid w-100' src='image/france/IMAGES%20%20RES/".$image[$i]."' alt='".$image[$i]."'>
												".$text[$i]."
												<img class='w-100 img-fluid' src='https://maps.googleapis.com/maps/api/staticmap?center=\".$latitude[$i].\",\".$longitude[$i].\"&size=1200x1000&maptype=hybrid&markers=color:blue%7Clabel:ICI%7C\".$latitude[$i].\",\".$longitude[$i].\"&zoom=15&key=AIzaSyD9oFdtfNI3g4dEwNAaB93zKTT5mSKZWm4'>
											  	<div id=\"map".$id[$i]."\" class=\"map\" onload='init(Number(".$longitude[$i]."),Number(".$latitude[$i]."),".$id[$i].");'>
											  	<iframe width=\"425\" height=\"350\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"https://www.openstreetmap.org/#map=8/".$latitude[$i]."/".$longitude[$i]."\"></iframe><br/><small><a href=\"https://www.openstreetmap.org/#map=8/".$latitude[$i]."/".$longitude[$i]."\">Afficher une carte plus grande</a></small>
											  	</div>
											  	</div>
											  <div class=\"modal-footer\">
